<header class="page-header" role="banner">
    ...
    <div class="page-logo">
        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative"
            ...
            <span class="mr-1 page-logo-text">SmartAdmin WebApp</span>
    ...
    <div class="ml-auto d-flex">
                        ...
                        <li>
                            <a href="#" class="app-list-item hover-white">
                                <span class="icon-stack">
                                    ...
                                    <i class="text-white ni ni-settings icon-stack-1x fs-lg"></i>
                                </span>
                        ...
                        <li>
                            <a href="#" class="app-list-item hover-white">
                                <span class="icon-stack">
                                    ...
                                    <i class="text-white base-10 icon-stack-1x"></i>
                        ...
                        <li>
                            <a href="#" class="app-list-item hover-white">
                                <span class="icon-stack">
                                    ...
                                    <i class="text-white ni ni-shield icon-stack-1x"></i>
                                </span>
                                <span class="app-list-name">
                                    Security
                                </span>
                        ...
                        <li>
                            <a href="#" class="app-list-item hover-white">
                                <span class="icon-stack">
                                    ...
                                    <span
                                        class="mt-2 position-absolute pos-top pos-left pos-right color-white fs-md fw-400">28</span>
                                </span>
                                <span class="app-list-name">
                                    Calendar
                                </span>
                        ...
                        <li>
                            <a href="#" class="app-list-item hover-white">
                                <span class="icon-stack">
                                    ...
                                    <i class="text-white ni ni-graph icon-stack-1x"></i>
                                </span>
                                <span class="app-list-name">
                                    Stats
                                </span>
                        ...
                        <li>
                            <a href="#" class="app-list-item hover-white">
                                <span class="icon-stack">
                                    ...
                                    <i class="text-white ni ni-envelope icon-stack-1x"></i>
                                </span>
                                <span class="app-list-name">
                                    Messages
                                </span>
                        ...
                        <li>
                            <a href="#" class="app-list-item hover-white">
                                <span class="icon-stack">
                                    ...
                                    <i class="text-white fal fa-dot-circle icon-stack-1x opacity-85"></i>
                                </span>
                                <span class="app-list-name">
                                    Photos
                                </span>
                        ...
                        <li>
                            <a href="#" class="app-list-item hover-white">
                                <span class="icon-stack">
                                    ...
                                    <i class="text-white fal fa-globe icon-stack-1x opacity-85"></i>
                                </span>
                                <span class="app-list-name">
                                    Maps
                                </span>
                        ...
                        <li>
                            <a href="#" class="app-list-item hover-white">
                                <span class="icon-stack">
                                    ...
                                    <i class="text-white fal fa-comment-alt icon-stack-1x"></i>
                                </span>
                                <span class="app-list-name">
                                    Chat
                                </span>
                        ...
                        <li>
                            <a href="#" class="app-list-item hover-white">
                                <span class="icon-stack">
                                    ...
                                    <i class="opacity-50 base-7 icon-stack-2x color-warning-800"></i>
                                    <i class="text-white fal fa-phone icon-stack-1x"></i>
                                </span>
                                <span class="app-list-name">
                                    Phone
                                </span>
                        ...
                        <li>
                            <a href="#" class="app-list-item hover-white">
                                <span class="icon-stack">
                                    ...
                                    <i class="text-white fal fa-chart-line icon-stack-1x"></i>
                                </span>
                                <span class="app-list-name">
                                    Projects
                                </span>
        ...
        {{-- <div>
            ...
            <div class="dropdown-menu dropdown-menu-animated dropdown-xl">
                <div
                    class="mb-2 dropdown-header bg-trans-gradient d-flex justify-content-center align-items-center rounded-top">
                    <h4 class="m-0 text-center color-white">
                        11 New
                ...
                <ul class="nav nav-tabs nav-tabs-clean" role="tablist">
                    <li class="nav-item">
                        <a class="px-4 nav-link fs-md js-waves-on fw-500" data-toggle="tab" href="#tab-messages"
                            data-i18n="drpdwn.messages">Messages</a>
                    </li>
                    <li class="nav-item">
                        <a class="px-4 nav-link fs-md js-waves-on fw-500" data-toggle="tab" href="#tab-feeds"
                            data-i18n="drpdwn.feeds">Feeds</a>
                    </li>
                    <li class="nav-item">
                        <a class="px-4 nav-link fs-md js-waves-on fw-500" data-toggle="tab" href="#tab-events"
                                    ...
                                    <a href="#" class="d-flex align-items-center">
                                        ...
                                        <span class="flex-1 ml-1 d-flex flex-column">
                                            <span class="name">Melissa Ayre <span
                                                    class="mt-1 badge badge-primary fw-n position-absolute pos-top pos-right">INBOX</span></span>
                                ...
                                <li class="unread">
                                    <a href="#" class="d-flex align-items-center">
                                        ...
                                        <span class="flex-1 ml-1 d-flex flex-column">
                                            ...
                                            <span class="mt-1 fs-nano text-muted">2 minutes ago</span>
                                        </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="mr-2 status status-success">
                                            <span class="profile-image rounded-circle d-inline-block"
                                        ...
                                        <span class="flex-1 ml-1 d-flex flex-column">
                                            ...
                                            <span class="msg-a fs-sm">Msed quia non numquam eius</span>
                                            <span class="mt-1 fs-nano text-muted">3 days ago</span>
                                        </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        <span class="mr-2 status status-warning">
                                            <span class="profile-image rounded-circle d-inline-block"
                                        ...
                                        <span class="flex-1 ml-1 d-flex flex-column">
                                            ...
                                            <span class="msg-a fs-sm">Msed quia non numquam eius</span>
                                            <span class="mt-1 fs-nano text-muted">2 weeks ago</span>
                                        </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        ...
                                        <span class="flex-1 ml-1 d-flex flex-column">
                                            ...
                                            <span class="msg-a fs-sm">Msed quia non numquam eius</span>
                                            <span class="mt-1 fs-nano text-muted">3 weeks ago</span>
                                        </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        ...
                                        <span class="flex-1 ml-1 d-flex flex-column">
                                            ...
                                            <span class="msg-a fs-sm">Msed quia non numquam eius</span>
                                            <span class="mt-1 fs-nano text-muted">one month ago</span>
                                        </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="d-flex align-items-center">
                                        ...
                                        <span class="flex-1 ml-1 d-flex flex-column">
                                            ...
                                            <span class="msg-a fs-sm">Msed quia non numquam eius</span>
                                            <span class="mt-1 fs-nano text-muted">one year ago</span>
                                        </span>
                                    </a>
                                </li>
                            </ul>
                                    ...
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <span class="flex-1 d-flex flex-column">
                                            <span class="name d-flex align-items-center">Administrator <span
                                                    class="ml-1 badge badge-success fw-n">UPDATE</span></span>
                                ...
                                <li>
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        <div class="flex-1 d-flex flex-column">
                                            ...
                                            <span class="mt-2 msg-a fs-sm">Bring to the table win-win survival
                                    ...
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        ...
                                        <div class="flex-1 d-flex flex-column">
                                            ...
                                            <div class="mt-2 fs-sm d-flex align-items-center">
                                                <span class="mr-1 profile-image-md rounded-circle d-inline-block"
                                ...
                                <li>
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        ...
                                        <div class="flex-1 d-flex flex-column">
                                            ...
                                            <span class="mt-2 msg-a fs-sm">Nanotechnology immersion along the
                                ...
                                <li>
                                    <div class="d-flex align-items-center show-child-on-hover">
                                        ...
                                        <div class="flex-1 d-flex flex-column">
                                            ...
                                            <div
                                                class="p-3 show-on-hover-parent position-absolute pos-right pos-bottom">
                                                <a href="#" class="text-muted" title="delete"><i
                                                        class="fal fa-trash-alt"></i></a>
                                            </div>
                                        </div>
                            ...
                            <div class="h-auto">
                                <table class="table m-0 border-0 table-bordered table-calendar w-100 h-100">
                                    ...
                                    <tr>
                                        ...
                                        <td>5</td>
                                        <td><i
                                                class="mt-1 ml-1 fal fa-birthday-cake position-absolute pos-left pos-top text-primary"></i>
                                            6</td>
                                    </tr>
                                    <tr>
                                        <td>7</td>
                ...
                <div
                    class="px-3 py-2 text-right bg-faded d-block rounded-bottom border-faded border-bottom-0 border-right-0 border-left-0">
        ...
        <!-- app user menu -->
            ...
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <a class="px-3 mt-3 border-0 nav-link btn btn-primary text-light" href="route('logout')"
