...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <nav class="container pt-5 bg-transparent navbar fixed-top navbar-expand-lg fs-5">
            <div class="container-fluid">
                ...
                <div class="py-3w collapse navbar-collapse" style="justify-content: right" id="navbarNavDropdown">
                    ...
                    <li class="nav-item">
                        <a class="nav-link font-shadow fs-6 text-secondary" href="/project">Doctor Appointment</a>
                    </li>
                    <li class="nav-item">
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <a class="px-3 border-0 nav-link btn btn-primary text-light" href="route('logout')"
