                    ...
                    <div class="p-4 w-100 ms-3">
                        ...
                        <form method="POST" action="{{ route('password.store') }}">
                            ...
                            <div class="input-container">
                                <input type="email" id="email" placeholder=" " name="email" value="{{$request->email}}" required>
                            ...
                            <button type="submit" class="py-3 border-0 btn btn-primary w-100 fs-6 rounded-3">Ubah</button>
                        </form>
